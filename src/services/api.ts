...
export const API_URL = 'http://20.246.74.138:5173/api'; // Replace with your actual API URL
export const API_URL_Auth = ' http://20.246.74.138:5173/auth';
...
//   //const apiUrl = 'http://20.246.74.138:5173/api/generate_short_profile_pdf/';
...
export const downloadProfilePdf = async (profileId: string, format: string) => {
  const apiUrl = `http://20.246.74.138:5173/api/admin-pdf-with-format/?profile_id=${encodeURIComponent(profileId)}&pdf_format=${encodeURIComponent(format)}`;
...
//   const url = `http://20.246.74.138:5173/api/express-interest/?${params.toString()}`;
...
export const BirthStarApi = ' http://20.246.74.138:5173/api/birth-stars/';
export const GothramApi = ' http://20.246.74.138:5173/api/gothrams/';
...
export const addOrUpdateProfileHolder = `http://20.246.74.138:5173/api/profile-holders/`;
...
//edit profile page
export const getParentOccupation = `http://20.246.74.138:5173/auth/Get_Parent_Occupation/`;
//vys assist
