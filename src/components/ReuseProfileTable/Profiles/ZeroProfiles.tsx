...
//   const baseUrl = ` http://20.84.40.134:8000/api/newprofile_get/?page_name=7&page=${page}`;
...
//   const baseUrl = ` http://20.84.40.134:8000/api/newprofile_get/?page_name=2&page=${page}`;
//   const params = new URLSearchParams({
//     page_size: rowsPerPage.toString(),
