...
const LoginDetailsTempList = () => {
    ...
    const fetchLoginDetails = async () => {
        try {
            const response = await axios.get('http://20.84.40.134:8080/api/logindetails_temp/');
    ...
    const handleAccept = async (id) => {
        try {
            const response = await axios.patch(`http://20.84.40.134:8080/api/logindetails_temp/${id}/accept/`);
            fetchLoginDetails();
    ...
    const handleDecline = async (id) => {
        try {
            await axios.patch(`http://20.84.40.134:8080/api/logindetails_temp/${id}/`, { status: 0 });
            fetchLoginDetails();
