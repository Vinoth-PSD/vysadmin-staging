...
const RasiList = () => {
    ...
    const fetchRasis = async () => {
        const response = await axios.get('http://20.84.40.134:8080/api/accounts/rasis/');
    ...
    const addOrUpdateRasi = async () => {
        ...
        if (editRasiId) {
            await axios.put(`http://20.84.40.134:8080/api/accounts/rasis/${editRasiId}/`, rasiData);
        } else {
            await axios.post('http://20.84.40.134:8080/api/accounts/rasis/', rasiData);
        }
        setNewRasi('');
        setShowPopup(false);
        setEditRasiId(null);
    ...
    const confirmDeleteRasi = async () => {
        await axios.delete(`http://20.84.40.134:8080/api/accounts/rasis/${rasiToDelete}/`);
