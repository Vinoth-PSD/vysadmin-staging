...
const PlaceOfBirthList = () => {
    ...
    const fetchPlacesOfBirth = async () => {
        const response = await axios.get('http://20.84.40.134:8000/api/accounts/place-of-births/');
    ...
    const addOrUpdatePlaceOfBirth = async () => {
        ...
        if (editPlaceId) {
            await axios.put(`http://20.84.40.134:8000/api/accounts/place-of-births/${editPlaceId}/`, placeData);
        } else {
            await axios.post('http://20.84.40.134:8000/api/accounts/place-of-births/', placeData);
        }
        setNewPlaceOfBirth('');
        setShowPopup(false);
        setEditPlaceId(null);
    ...
    const confirmDeletePlace = async () => {
        await axios.delete(`http://20.84.40.134:8000/api/accounts/place-of-births/${placeToDelete}/`);
