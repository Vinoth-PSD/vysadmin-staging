...
const LagnamList = () => {
    ...
    const fetchLagnams = async () => {
        const response = await axios.get('http://20.84.40.134:8000/api/accounts/lagnams/');
    ...
    const addOrUpdateLagnam = async () => {
        ...
        if (editLagnamId) {
            await axios.put(`http://20.84.40.134:8000/api/accounts/lagnams/${editLagnamId}/`, lagnamData);
        } else {
            await axios.post('http://20.84.40.134:8000/api/accounts/lagnams/', lagnamData);
        }
        setNewLagnam('');
        setShowPopup(false);
    ...
    const confirmDeleteLagnam = async () => {
        await axios.delete(`http://20.84.40.134:8000/api/accounts/lagnams/${lagnamToDelete}/`);
