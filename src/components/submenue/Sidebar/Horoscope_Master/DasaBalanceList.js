...
const DasaBalanceList = () => {
    ...
    const fetchDasaBalances = async () => {
        const response = await axios.get('http://20.246.74.138:5173/api/accounts/dasa-balances/');
        setDasaBalances(response.data);
    };

    const addDasaBalance = async () => {
        await axios.post('http://20.246.74.138:5173/api/accounts/dasa-balances/', { balance: newDasaBalance });
        setNewDasaBalance('');
        setShowPopup(false);
        fetchDasaBalances();
    ...
    const deleteDasaBalance = async (id) => {
        await axios.delete(`http://20.246.74.138:5173/api/accounts/dasa-balances/${id}/`);
        fetchDasaBalances();
    };
    ...
    const updateDasaBalance = async () => {
        await axios.put(`http://20.246.74.138:5173/api/accounts/dasa-balances/${editDasaBalanceId}/`, { balance: editedDasaBalance });
