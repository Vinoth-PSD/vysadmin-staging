...
const HighestEducationList = () => {
    ...
    const fetchHighestEducations = async () => {
        const response = await axios.get('http://20.84.40.134:8000/api/accounts/highest-educations/');
        setHighestEducations(response.data);
    };

    const addHighestEducation = async () => {
        await axios.post('http://20.84.40.134:8000/api/accounts/highest-educations/', { degree: newHighestEducation });
    ...
    const confirmDeleteEducation = async () => {
        await axios.delete(`http://20.84.40.134:8000/api/accounts/highest-educations/${educationToDelete}/`);
    ...
    const editHighestEducation = async () => {
        await axios.put(`http://20.84.40.134:8000/api/accounts/highest-educations/${editHighestEducationData.id}/`, editHighestEducationData);
