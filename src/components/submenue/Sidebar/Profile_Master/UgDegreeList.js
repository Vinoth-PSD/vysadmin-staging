...
const UgDegreeList = () => {
    ...
    const fetchUgDegrees = async () => {
        const response = await axios.get('http://20.246.74.138:5173/api/accounts/ug-degrees/');
        setUgDegrees(response.data);
    };

    const addUgDegree = async () => {
        await axios.post('http://20.246.74.138:5173/api/accounts/ug-degrees/', { degree: newUgDegree });
        setNewUgDegree('');
    ...
    const confirmDeleteUgDegree = async () => {
        await axios.delete(`http://20.246.74.138:5173/api/accounts/ug-degrees/${degreeToDelete}/`);
    ...
    const editUgDegree = async () => {
        await axios.put(`http://20.246.74.138:5173/api/accounts/ug-degrees/${editUgDegreeId}/`, { degree: editedUgDegree });
