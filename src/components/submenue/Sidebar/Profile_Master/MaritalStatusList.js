...
const MaritalStatusList = () => {
    ...
    const fetchMaritalStatuses = async () => {
        const response = await axios.get('http://20.84.40.134:8000/api/accounts/marital-statuses/');
        setMaritalStatuses(response.data);
    };

    const addMaritalStatus = async () => {
        try {
            await axios.post('http://20.84.40.134:8000/api/accounts/marital-statuses/', { status: newMaritalStatus });
            setNewMaritalStatus('');
    ...
    const editMaritalStatus = async () => {
        await axios.put(`http://20.84.40.134:8000/api/accounts/marital-statuses/${editMaritalStatusData.id}/`, editMaritalStatusData);
        fetchMaritalStatuses();
    ...
    const deleteMaritalStatus = async () => {
        await axios.delete(`http://20.84.40.134:8000/api/accounts/marital-statuses/${statusToDelete}/`);
