...
const AnnualIncomeList = () => {
    ...
    const fetchAnnualIncomes = async () => {
        const response = await axios.get('http://20.84.40.134:8000/api/accounts/annual-incomes/');
        setAnnualIncomes(response.data);
    };

    const addAnnualIncome = async () => {
        await axios.post('http://20.84.40.134:8000/api/accounts/annual-incomes/', { income: newAnnualIncome });
        setNewAnnualIncome('');
    ...
    const confirmDeleteIncome = async () => {
        await axios.delete(`http://20.84.40.134:8000/api/accounts/annual-incomes/${incomeToDelete}/`);
    ...
    const editAnnualIncome = async () => {
        await axios.put(`http://20.84.40.134:8000/api/accounts/annual-incomes/${editAnnualIncomeData.id}/`, editAnnualIncomeData);
