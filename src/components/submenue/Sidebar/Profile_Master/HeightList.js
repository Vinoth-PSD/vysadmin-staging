...
const HeightList = () => {
    ...
    const fetchHeights = () => {
        axios.get('http://20.84.40.134:8080/api/heights/')
            .then(response => {
    ...
    const handleAddOrEditHeight = () => {
        if (editHeightId) {
            axios.put(`http://20.84.40.134:8080/api/heights/${editHeightId}/`, newHeight)
                .then(response => {
            ...
            axios.post('http://20.84.40.134:8080/api/heights/', newHeight)
                .then(response => {
    ...
    const confirmDeleteHeight = () => {
        axios.delete(`http://20.84.40.134:8080/api/heights/${heightToDelete}/`)
            .then(() => {
