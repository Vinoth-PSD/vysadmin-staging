...
const ParentsOccupationList = () => {
    ...
    const fetchParentsOccupations = async () => {
        const response = await axios.get('http://20.246.74.138:5173/api/accounts/parents-occupations/');
        setParentsOccupations(response.data);
    };

    const addParentsOccupation = async () => {
        await axios.post('http://20.246.74.138:5173/api/accounts/parents-occupations/', { occupation: newParentsOccupation });
    ...
    const confirmDeleteOccupation = async () => {
        await axios.delete(`http://20.246.74.138:5173/api/accounts/parents-occupations/${occupationToDelete}/`);
    ...
    const editParentsOccupation = async () => {
        await axios.put(`http://20.246.74.138:5173/api/accounts/parents-occupations/${editParentsOccupationData.id}/`, editParentsOccupationData);
        fetchParentsOccupations();
