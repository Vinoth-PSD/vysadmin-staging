...
const EditUploadImages: React.FC<pageProps> = ({isUploadImagesOpen, setIsUploadImagesOpen}) => {
  ...
  const handleFileChange = (
    ...
    if (buttonIndex !== undefined) {
      ...
      // For Horoscope Image and ID Proof: Only one file, so we replace the existing one
